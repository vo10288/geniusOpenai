...
class AIAssistantWithGenie:
    ...
    def update_genie_animation(self):
        ...
        # Controlli
        controls_text = small_font.render("SPAZIO: Parla | Q/ESC: Esci | V: Nascondi video", True, (150, 150, 150))
    ...
    def listen_to_user(self):
        ...
        try:
            ...
            try:
                ...
                # CONFERMA VOCALE invece che testuale
            ...
            while True:
                ...
                for event in pygame.event.get():
                    if event.type == pygame.QUIT:
                        ...
                        elif event.key == pygame.K_SPACE and self.face_detected and not self.is_processing:
                ...
                if ret:
                    ...
                    # LOGICA ANTI-ACCAVALLAMENTO:
                    # Fa una domanda solo se TUTTE le condizioni sono soddisfatte
                    ...
                    if (faces_detected and 
                        ...
                        not self.is_processing):  # ← CHIAVE: non elabora già
                        ...
                        def auto_interaction():
                            ...
                            if not self.shutdown and not self.is_listening and self.is_processing:
                                user_question = self.listen_to_user()
                                if user_question and not self.shutdown:
                                    self.complete_interaction(user_question)
                                else:
...
def main():
    ...
    try:
        ...
        print("     • Nessuna tastiera richiesta!")
        print("   ⚙️  LOGICA MIGLIORATA:")
